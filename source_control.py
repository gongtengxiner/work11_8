#每个频段的数据写入一个文本，多个USRP数据自己写入自己的文本。
import os
#import thread 
import threading
...
def usrp1():
	os.system("python2 ./usrp_spectrum_sense_10.27.py -a serial=31DDABF -A TX/RX -s 50e6 -g 30 --tune-delay=0.005 --dwell-delay=0.005 -b 97656.25 -q 0 2e9 5e9")

def usrp2():
	os.system("python2 ./usrp_spectrum_sense_10.27_usrp2.py -a serial=31DD6FA -A TX/RX -s 50e6 -g 30 --tune-delay=0.005 --dwell-delay=0.005 -b 97656.25 -q 0 2e9 5e9")
